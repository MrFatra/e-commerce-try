...
const SingleImageDropzone = React.forwardRef<HTMLInputElement, InputProps>(
    (
        { dropzoneOptions, width, height, value, setValue, className, disabled, onChange },
        ref,
    ) => {
                ...
                >
                    ...
                    {imageUrl ? (
                        ...
                        <Image
                            ...
                            className={`object-contain w-full h-full ${isImageLoading ? 'blur-lg' : 'blur-none'}`}
                        />
                        // <img
                        ...
                        <div className="flex flex-col items-center justify-center text-xs text-gray-500">
                            ...
                            <div className="text-gray-500 font-medium">Drag & Drop to Upload</div>
                            <div className="mt-3">
                                <Button type='button' disabled={disabled} className='text-[.700rem] font-medium bg-slate-700' size={'sm'}>Select</Button>
                            </div>
                        </div>
                    )}

                    {/* Remove Image Icon */}
                    {imageUrl && !disabled && (typeof value !== 'string' && File) && (
                        <div
